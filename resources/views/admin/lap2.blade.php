...
<head>
    ...
    <script>
        window.addEventListener('load',function(){
            html2canvas(document.querySelector("#BlangkoO_13496")).then(canvas => {
                var doc = new jsPDF('p');
                var imgData = canvas.toDataURL(
                    'image/png');
                doc.addImage(imgData,'PNG', -58, 10);
                doc.save('laporan8.pdf');
            });
        });
    </script>
</head>
...
<body>
<!--[if !excel]>&nbsp;&nbsp;<![endif]-->
<!--Informasi berikut dihasilkan oleh Terbitan Microsoft Excel sebagai panduan
Halaman Web.-->
<!--Jika item yang sama diterbitkan ulang dari Excel, semua informasi di antara
tag DIV akan digantikan.-->
<!----------------------------->
<!--MULAI KELUARAN DARI TERBITAN EXCEL SEBAGAI PANDUAN HALAMAN WEB -->
<!----------------------------->

<div id="BlangkoO_13496" class="mt-5" align=center x:publishsource="Excel">
 ...
 width:33pt'>
  ...
  width:117pt'>Blangko 08</td>
        ...
        <tr height=20 style='height:15.0pt'>
            ...
            <td class=xl6813496 colspan=2>bulan November</td>
        </tr>
        <tr height=20 style='height:15.0pt'>
...
<!----------------------------->
<!--AKHIR KELUARAN DARI TERBITAN EXCEL SEBAGAI PANDUAN HALAMAN WEB-->
<!----------------------------->
</body>
